  ...
  return (
    <div className="bg-white rounded-lg shadow-md w-full max-w-sm mx-auto">
      ...
      <p className="text-center text-gray-600 text-lg font-light pr-6 pl-6">
        Scan the QR Code below with your <b>authenticator app</b> - if not
        Please install extension in your PC
      </p>
      ...
      <div className="p-6">
        ...
        <div className="flex items-center mt-3 mb-3">
          <div className="border-t border-1 border-gray-500 flex-grow"></div>
